...
当前唯一可安全限定来源的明文信号，是安鑫物业向 `webgw.alipay-eco.com` 发出的推广请求携带自身 `servicewechat.com/wx75eeff0fa2bb9e12/...` Referer。三端脚本仅在该 Referer 完整匹配时返回空响应；同一主机上来自淘宝闪购、其它小程序、浏览器或应用的请求全部透传。
